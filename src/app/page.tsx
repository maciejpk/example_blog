  ...
  return (
    <main className="max-w-5xl mx-auto py-10 px-4">
      <section className="mb-12">
        ...
        <p className="mb-4">
          Communism played a major role in shaping the 20th century, and the remaining communist regimes still play an important role in global politics. Especially with the rise of China, pronouncements of the end of the communist era seem short-sighted. Rather, communism is a political project that, despite the collapse of the Soviet Union, has proven to be enduring and continues to challenge the &quot;free world.&quot; This challenge is not limited to military tensions, such as those between the US and China or nuclear threats from North Korea. Communist regimes also offer alternative models in areas such as distributive justice (e.g., Venezuela or Cuba) and diverge from Western modernity, which is seen by some as tainted by colonialism, as exemplified by China’s Belt and Road initiative.
        </p>
        <p className="mb-4">
          The &quot;socialist experiment&quot; still holds appeal and relevance. Against this backdrop, analyzing communist regimes from a political science perspective remains crucial. However, comparative political science has largely shifted focus from communist systems to issues of transformation and democratization. This conference aims to re-engage with questions about the nature of communist systems across time and geography.
        </p>
        <p className="mb-4">
          Inspired by the &quot;varieties of capitalism&quot; framework, this conference seeks to trace internal differentiation within the &quot;communist world&quot; using two dimensions: temporality and informality. Temporality reflects how the time of a regime’s rise affects its character, as shown in authoritarian studies. Informality addresses how similar institutional setups manifest differently due to local adaptations and practices.
        </p>
        <p className="mb-4">
          Experts gathered in Chemnitz will examine how communist systems differ both from other authoritarian regimes and from each other, drawing on a range of regional and historical perspectives.
        </p>
      </section>
